      ...
      <div className="lg:hidden block backgroundColor1 min-h-screen pt-5">
        <div className="px-4">
          <p className="text-[#B8B8B8] font-bold text-xs">
            Student Dashboard /{" "}
            <span className="text-black text-[10px]"> My Courses</span>
          </p>
        ...
        {showDialogBox && (
          <div className="fixed z-40 top-0 right-0 left-0 bottom-0 bg-[#000000b4] flex justify-center items-center p-4">
            <div className="w-full max-w-[95%] gradient9 rounded-2xl pt-4 pb-6">
              {/* Header with Close Icon */}
              <div className="flex justify-between items-center px-4">
                <p className="text-[10px] font-bold">Course Facilitator</p>
                <CloseIcon
                  className="h-6 w-6"
              ...
              {/* Main Content */}
              <div className="bg-[#EBF3FF] mx-3 mt-2 rounded-2xl p-4">
                <div className="space-y-3">
                  {/* General Information and Course Code */}
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <p className="text-[8px] font-bold">
                        General Information
                      </p>
                      <p className="text-[7px] textColor6 mt-1">Mathematics</p>
                      <input
                        type="text"
                        disabled
                        className="shadow-[0_0_50px_-12px_rgba(0,0,0,0.25)] border rounded-xl p-1 w-full text-[8px] mt-1"
                      />
                    </div>
                    <div>
                      <p className="text-[8px] font-bold">Course Code</p>
                      <p className="text-[7px] textColor6 mt-1">Mathematics</p>
                      <input
                        type="text"
                        value={code}
                  ...
                  {/* Course Title */}
                  <div>
                    <p className="text-[8px] font-bold">Course Title</p>
                    <input
                      type="text"
                      disabled
                      className="shadow-[0_0_50px_-12px_rgba(0,0,0,0.25)] border rounded-xl p-3 w-full text-[8px] mt-1"
                    />
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-[7px] textColor6">
                      MATH303 | Sir AbihSolo
                    </p>
                    <p className="text-[7px] text-[#3884FF]">
                      See Course Details
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <progress
                      value={60}
                      max={100}
                      className="w-full rounded-3xl h-2 mt-1
                  ...
                  <div className="grid grid-cols-3 gap-1 mt-1">
                    <button className="flex items-center justify-center gap-1 border rounded-md py-1.5">
                      <BooksIcon className="h-3" />
                      <span className="text-[7px] font-bold">Materials</span>
                    </button>
                    <button className="flex items-center justify-center gap-1 border rounded-md py-1.5">
                      <BookOpenIcon className="h-3" />
                      <span className="text-[7px] font-bold">Assignment</span>
                    </button>
                    <button className="flex items-center justify-center gap-1 border rounded-md py-1.5">
                      <AnalyticsReportIcon className="h-3" />
                      <span className="text-[7px] font-bold">Grades</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className="backgroundColor1 min-h-screen">
          <div className="pl-3 pt-5 pr-3">
            <p className="text-[#B8B8B8] font-bold text-sm">
              Student Dashboard  / {" "}
              <span className="text-black text-xs"> My Courses</span>
            </p>
            <p className="text-[10px] text-[#B8B8B8] font-bold">
              Courses are base on the current GES curriculum for all Basic
              School
            </p>
                ...
                <div className="h-[80%] bg-[#EBF3FF] mt-3 rounded-2xl p-5">
                  <div className="flex justify-between items-center gap-2">
                    <div className="w-full">
                      ...
                      <p className="text-[8px] textColor6 mt-1">
                        Mathematics
                      </p>{" "}
                      <br />
                      <input
                        ...
                        name=""
                        id=""
                        className=" shadow-[0_0_50px_-12px_rgba(0,0,0,0.25)] border rounded-2xl p-1 w-full"
                      />
                    </div>
                    <div className="w-full">
                      <p>Courses Code</p>
                  ...
                  <input
                    ...
                    disabled
                    id=""
                    className=" shadow-[0_0_50px_-12px_rgba(0,0,0,0.25)] border rounded-2xl p-5 w-full"
                  />
